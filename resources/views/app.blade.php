...
<script>
    ...
    console.log("%cTus datos estan siendo guardados en este momento y serán analizados por el área de seguridad.", "font-family: ';Arial';, serif; color: black; font-size: 20px");
</script>
</body>
</html>
