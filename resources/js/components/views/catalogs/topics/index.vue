    ...
    <div>
        ...
        <el-dialog
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="success" @click="disableTopic(removeHash)">Aceptar</el-button>
            </span>
        </el-dialog>
    </div>
</template>
            ...
            getTopics(currentPage = 1) {
                ...
                axios.get('/api/cats/get/catalogos', data).then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.topics = response.data.topic.data;
                        this.pagination.total = response.data.topic.total;
                        this.pagination.currentPage = response.data.topic.current_page;
                        this.pagination.perPage = response.data.topic.per_page;
