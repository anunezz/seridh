    ...
    <div>
        ...
        <el-row :gutter="20">
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column
                        prop="name"
                        label="Nombre de Poder de Gobierno">
                    </el-table-column>
                    <el-table-column
        ...
        <el-dialog title="Nuevo Registro"
            ...
            <el-input
                ...
                placeholder="Nombre de Poder de Gobierno"
        ...
        <el-dialog title="Editar Registro"
            ...
            <el-input
                ...
                v-model="powers[indexRegister].name"
                maxlength="100"
                clearable>
            </el-input>
            <span slot="footer" class="dialog-footer">
    ...
    export default {
        ...
        methods: {
            ...
            newRegister() {
                ...
                let data = {cat: 3, name: this.newRegisterName};
            ...
            editRegister() {
                ...
                let data = {id: this.hashRegister, cat: 3, name: this.powers[this.indexRegister].name};
                ...
                axios.put('/api/cats/update/register', data).then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.powers[this.indexRegister].name = this.nameRegister;
            ...
            onNameChanged(value) {
                this.powers[this.indexRegister].name = value.replace(/[#$%&?|+=*!<>"';()/{}[\]\\]/g, "");
            },
            ...
            disablePower(id) {
                ...
                axios.delete(`/api/cats/remove/power/${id}`, {responseType: 'blob'}).then(response => {
                    this.stopLoading();
                    this.getPowers();
