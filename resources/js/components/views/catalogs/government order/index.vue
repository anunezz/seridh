<template>
    <div>
        <header-section icon="el-icon-document" title="Orden de Gobierno">
            <template slot="buttons">
                <el-col :span="5" :offset="7">
                    <el-button type="success" @click="newOrder" style="width: 100%">
                        Nuevo registro
                    </el-button>
                </el-col>
        ...
        <el-dialog title="Editar Registro"
            ...
            <span slot="footer" class="dialog-footer">
            <el-button type="danger" @click="getOrders(),editRegisterDialog = false">Cancelar</el-button>
            ...
            getOrders(currentPage = 1) {
                ...
                axios.get('/api/cats/get/catalogos', data).then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.orders = response.data.elements.data;
