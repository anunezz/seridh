<template>
    <div>
        <header-section icon="el-icon-document" title="ODS (Objetivos de Desarrollo Sostenible)">
            <template slot="buttons">
                <el-col :span="5" :offset="7">
                    <el-button type="success" @click="newOds" style="width: 100%">
                        Nuevo registro
                    </el-button>
                </el-col>
        ...
        <el-row :gutter="20">
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column
                        prop="name"
                        label="Nombre de Objetivos de Desarrollo Sostenible (ODS)">
                    </el-table-column>
                    <el-table-column
        ...
        <el-dialog title="Nuevo Registro"
            ...
            <el-input
                ...
                placeholder="Nombre de Objetivo de Desarrollo Sostenible"
        ...
        <el-dialog title="Editar Registro"
            ...
            <el-input
                ...
                placeholder="Objetivo de Desarrollo Sostenible"
                v-model="ods[indexRegister].name"
                maxlength="100"
                clearable>
            </el-input>
            <span slot="footer" class="dialog-footer">
            <el-button type="danger" @click="getOds(),editRegisterDialog = false">Cancelar</el-button>
            <el-button v-if="editRegisterDialog"
                       type="primary"
                       :disabled="ods[indexRegister].name === ''"
        ...
        <el-dialog
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="success" @click="disableOds(removeHash)">Aceptar</el-button>
            </span>
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getOds(currentPage = 1) {
                ...
                axios.get('/api/cats/get/catalogos', data).then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.pagination.total = response.data.ods.total;
                        this.pagination.currentPage = response.data.ods.current_page;
                        this.pagination.perPage = response.data.ods.per_page;
            ...
            newRegister() {
                ...
                let data = {cat: 7, name: this.newRegisterName};
            ...
            editRegister() {
                ...
                let data = {id: this.hashRegister, cat: 7, name: this.ods[this.indexRegister].name};
                ...
                axios.put('/api/cats/update/register', data).then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.ods[this.indexRegister].name = this.nameRegister;
            ...
            onNameChanged(value) {
                this.ods[this.indexRegister].name = value.replace(/[#$%&?|+=*!<>"';()/{}[\]\\]/g, "");
            },
            ...
            disableOds(id) {
                ...
                axios.delete(`/api/cats/remove/ods/${id}`, {responseType: 'blob'}).then(response => {
                    this.stopLoading();
                    this.getOds();
