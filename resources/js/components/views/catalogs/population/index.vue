    ...
    <div>
        ...
        <el-dialog
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="success" @click="disablePopulation(removeHash)">Aceptar</el-button>
            </span>
        </el-dialog>
    </div>
</template>
            ...
            getPopulation(currentPage = 1) {
                ...
                axios.get('/api/cats/get/catalogos', data).then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.populations = response.data.population.data;
                        this.pagination.total = response.data.population.total;
                        this.pagination.currentPage = response.data.population.current_page;
                        this.pagination.perPage = response.data.population.per_page;
